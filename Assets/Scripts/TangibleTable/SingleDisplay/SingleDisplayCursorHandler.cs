...
namespace TangibleTable.SingleDisplay
{
    ...
    {
        [Header("References")]
        [SerializeField] private TUIOCursorManager _tuioCursorManager;
        ...
        private void Awake()
        {
            ...
            if (_tuioCursorManager == null)
            {
                _tuioCursorManager = GetComponent<TUIOCursorManager>();
                if (_tuioCursorManager == null)
                {
        ...
        private void OnEnable()
        {
            ...
            if (_tuioCursorManager != null)
            {
                _tuioCursorManager.OnCursorDown.AddListener(HandleCursorDown);
                _tuioCursorManager.OnCursorMove.AddListener(HandleCursorMove);
                _tuioCursorManager.OnCursorUp.AddListener(HandleCursorUp);
            }
        }
        ...
        private void OnDisable()
        {
            ...
            if (_tuioCursorManager != null)
            {
                _tuioCursorManager.OnCursorDown.RemoveListener(HandleCursorDown);
                _tuioCursorManager.OnCursorMove.RemoveListener(HandleCursorMove);
                _tuioCursorManager.OnCursorUp.RemoveListener(HandleCursorUp);
            }
        }
